      ...
      <section className="surface space-y-4 p-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Generated assets are stored in Kontenta; paste a Drive folder here to keep your source
